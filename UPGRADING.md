...
**STEP 0 — Snapshot first.** Commit or branch your current state as a rollback
point. Confirm it exists before proceeding.
...
at all, you adopted a category-B item by mistake — revert it. On success, **record
